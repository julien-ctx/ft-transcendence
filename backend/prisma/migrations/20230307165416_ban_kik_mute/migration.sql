/*
  ...
  - Added the required column `EndMute` to the `RoomToUser` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "RoomToUser" ADD COLUMN     "EndMute" TIMESTAMP(3) NOT NULL,
